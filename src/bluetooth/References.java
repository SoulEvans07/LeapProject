...
public class References {
    ...
    public static String lWaiting = "Waiting for LeapMotion...";
    public static String lConnected = "LeapMotipn Connected";
    public static String lClosing = "LeapMotion Closing...";
}
